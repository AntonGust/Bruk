...
| Airon Operator + CRDs | 🔨 Built & gated (Phase 3.2, 2026-07-03: `operator/`, ADR-0007; CI + 80% coverage + kind e2e green; ships as suspended HelmRelease — no cluster rollout yet) |
