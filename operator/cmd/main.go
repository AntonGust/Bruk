...
import (
	...
	"github.com/AntonGust/Bruk/operator/internal/controller"
...
func main() {
	...
	if err := (&controller.BrukTenantReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "bruktenant")
		os.Exit(1)
	}
	if err := (&controller.BrukModelReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "brukmodel")
		os.Exit(1)
	}
	if err := (&controller.InferenceServiceReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "inferenceservice")
		os.Exit(1)
	}
